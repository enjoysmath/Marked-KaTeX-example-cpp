...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_PreviewPage_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_PreviewPage_t qt_meta_stringdata_PreviewPage = {
    {
QT_MOC_LITERAL(0, 11) // "PreviewPage"
...
const QMetaObject PreviewPage::staticMetaObject = { {
    ...
    qt_meta_stringdata_PreviewPage.offsetsAndSize,
    qt_meta_data_PreviewPage,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_PreviewPage_t
, QtPrivate::TypeAndForceComplete<PreviewPage, std::true_type>
